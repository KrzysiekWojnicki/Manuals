...
if [ "$color_prompt" = yes ]; then
	#jak bym był sprytniejszy to bym zrobił zmienne na różne części promta i je wygodnie wstawiał
	RED='\[\033[01;31m\]'
    PS1='${debian_chroot:+($debian_chroot)}[\[\e[0;35m\]\A\[\e[m\]]\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '
else
...
if [ -x /usr/bin/dircolors ]; then
    ...
    alias e='evince' #przeglądarka pdf
    alias a='apropos'
    alias v='vim'
    alias ls='ls --color=auto'
    alias u='sudo apt-get update ; sudo apt-get upgrade '	
    alias z='sudo shutdown  '
